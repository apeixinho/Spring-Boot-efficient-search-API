...
public class CarTest {
        ...
        public void should_return_car_when_get_car_by_id() throws Exception {
                ...
                assertThat(car.getCreateDate())
                                .isEqualTo(LocalDate.parse("1931-02-01", DateTimeFormatter.ofPattern("yyyy-MM-d")));
        }
        ...
        public void should_return_car_list_when_get_car_sorted_by_createDate_in_ASC_order() throws Exception {
                ...
                List<Car> carList = objectMapper.readValue(result.andReturn().getResponse().getContentAsString(),
        ...
        @Test
        public void should_return_car_list_when_get_car_for_specific_criteria_sorted_by_createDate_in_DESC_order()
                        throws Exception {
                ...
                assertTrue(carList.stream()
                                .allMatch(car -> car.getCountry().equals("Japan") && car.getType().equals("Small")));
        ...
        @Test
        public void should_return_car_list_page_when_get_car_for_specific_criteria_sorted_by_createDate_in_DESC_order()
                        throws Exception {
                ...
                assertTrue(carList.stream()
                                .allMatch(car -> car.getCountry().equals("Germany") && car.getType().equals("Sedan")));

                List<LocalDate> actualCreatedDateList = carList.stream().map(Car::getCreateDate)
                                .collect(Collectors.toList());
                assertThat(actualCreatedDateList.toString())
                                .hasToString("[2018-07-09, 2018-02-13, 2017-07-21, 2017-07-17, 2017-02-04]");
        }
